...
void inserirEsquerda(No *no, int valor){
    if (no->anterior == NULL){
        ...
        if (valor < no->anterior->valor){
            inserirEsquerda(no->anterior, valor);
        }
        if (valor > no->anterior->valor){
            inserirDireita(no->anterior, valor);
        }
    }
}
...
void inserirDireita(No *no, int valor){
    if (no->proximo == NULL){
        ...
        if(valor > no->proximo->valor){
            inserirDireita(no->proximo,valor);
        }
        if(valor < no->proximo->valor){
            inserirEsquerda(no->proximo,valor);
        }
    }  
}
